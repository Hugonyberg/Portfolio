#pragma once
// BehaviorTree - A C++ behavior tree single header library.
// Copyright 2015-2018 Par Arvidsson. All rights reserved.
// Licensed under the MIT license (https://github.com/arvidsson/BehaviorTree/blob/master/LICENSE).
...
namespace BT
{
    ...
    public:
        ...
        Status update() override
        {
            ...
            size_t minimumSuccess = static_cast<size_t>(minSuccess);
            size_t minimumFail = static_cast<size_t>(minFail);
