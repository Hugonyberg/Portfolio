...
namespace DreamEngine
{
	...
	public:
		...
		//static void MoveEndNodesToClosestCorners(const std::vector<Node*>& path, DE::Vector3f aStart, DE::Vector3f anEnd, std::shared_ptr<Navmesh> aNavmesh);
		//static void FunnelPathByMidPoints(const std::vector<Node*>& path, std::vector<DE::Vector3f>& outPath, DE::Vector3f aStart, DE::Vector3f anEnd, std::shared_ptr<Navmesh> aNavmesh);
		//static bool GetValidMidpoint(DE::Vector3f& aValidOutPoint, const DE::Vector3f& aFirstPos, const DE::Vector3f& aSecondPos, std::shared_ptr<Navmesh> aNavmesh);
		//static void RunAdditionalMidpointPass(std::vector<DE::Vector3f>& path, DE::Vector3f aStart, DE::Vector3f anEnd, std::shared_ptr<Navmesh> aNavmesh);
